...
class Downtime extends AbstractEntityService{
    ...
    private function validateStartTime($startTime, $classification) {
        if ($classification === "SCHEDULED") {
            ...
            if($startTime < $tomorrowUtc) {
                throw new \Exception("Can't edit or delete a SCHEDULED downtime starting within 24 hours.");
            }
        }
    }
    ...
    public function deleteValidation(\Downtime $dt) {
        // Can't delete dt if already started
        if($dt->hasStarted()) {
        ...
        // Can't delete dt if it starts within 24 hours
    ...
    public function editValidationDatePreConditions(\Downtime $dt){
        ...
        // Can't edit dt if it starts within 24 hours
